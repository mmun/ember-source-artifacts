...
enifed('ember-metal/expand_properties', ['exports', 'ember-metal/debug'], function (exports, _emberMetalDebug) {
  ...
  */
  ...
  function expandProperties(pattern, callback) {
    ...
    _emberMetalDebug.warn.apply(undefined, (function (str, opts) {
      var inBrace = 0;
      var char = undefined;
      for (var i = 0; i < str.length; i++) {
        char = str.charAt(i);
        ...
        if (char === '{') {
          ...
          return ['You are using a comma outside braces in ' + str + ' that was unintentionally being expanded. This property will no longer expand on Ember 2.13.', false, opts];
        }

        if (inBrace > 1 || inBrace < 0) {
          return ['You have nested or unbalanced properties in ' + str + ' that was unintentionally being expanded. This property will no longer expand on Ember 2.13.', false, opts];
        }
      }

      return ['The property ' + str + ' ended with unbalanced braces. This property will no longer expand on Ember 2.13.', inBrace === 0, opts];
